...
using poolprobase.Web.Models.Account;
using poolprobase.Authorization.Users;
using poolprobase.Controllers;
using poolprobase.Identity;
using poolprobase.Sessions;
using poolprobase.Web.Views.Shared.Components.TenantChange;
using Microsoft.AspNetCore.Authentication;
using Microsoft.AspNetCore.Identity;

namespace poolprobase.Web.Controllers
{
    public class AccountController : poolprobaseControllerBase
    {
