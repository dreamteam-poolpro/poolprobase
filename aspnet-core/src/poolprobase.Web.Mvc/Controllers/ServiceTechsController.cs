...
namespace poolprobase.Web.Mvc.Controllers
{
    ...
    [AbpMvcAuthorize(PermissionNames.Pages_ServiceTechs)]
    public class ServiceTechsController : poolprobaseControllerBase
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit( ServiceTech serviceTech)
        {
            if (serviceTech.ServiceTechID != serviceTech.ServiceTechID)
            {
                return NotFound();
            }
        ...
        public async Task<ActionResult> EditTechsModal(int id)
        {
            ...
            return View("_EditTechsModal", serviceTech);
        }

        public IActionResult CreateTechModal()
        {
           
            return View("_CreateTechModal");
        }
    }
}
