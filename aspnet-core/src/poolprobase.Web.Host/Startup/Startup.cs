...
namespace poolprobase.Web.Host.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new Info { Title = "poolprobase API", Version = "v1" });
            ...
            return services.AddAbp<poolprobaseWebHostModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "poolprobase API V1");
            }); //URL: /swagger
        }
